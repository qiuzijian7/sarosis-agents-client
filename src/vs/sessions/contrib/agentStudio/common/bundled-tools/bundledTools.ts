...
/**
 * Bundled Tool Definitions — 从 Hermes-Agent 迁移的工具定义
 *
 * 包含 69 个工具定义，按 category 分组。
 * 这些定义只有 schema（inputSchema），handler 由各 ToolProvider 实现。
 *
 * 工具集映射（对应 Hermes toolsets.py）：
...
export const BUNDLED_TOOL_DEFINITIONS: readonly IToolDefinition[] = [
	{
		name: "web_search",
	...
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["fetch_messages","search_members","create_thread","send_message"],"description":"Action to perform"},"channel_id":{"type":"string","description":"Channel ID"},"query":{"type":"string","description":"Search query"},"limit":{"type":"number","description":"Number of messages to fetch (default: 25)"}}},
		category: "discord",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["list_channels","list_roles","pin_message","assign_role","unpin_message"],"description":"Action to perform"},"channel_id":{"type":"string","description":"Channel ID"},"message_id":{"type":"string","description":"Message ID"},"user_id":{"type":"string","description":"User ID"},"role_id":{"type":"string","description":"Role ID"}}},
		category: "discord",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"group_id":{"type":"string","description":"Group ID"}},"required":["group_id"]},
		category: "yuanbao",
		source: 'hermes-bundled',
	},
	{
	...
	},
	{
		...
		inputSchema: {"type":"object","properties":{"user_id":{"type":"string","description":"User ID"},"text":{"type":"string","description":"Message text"}},"required":["user_id","text"]},
		category: "yuanbao",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"query":{"type":"string","description":"Sticker search query"}},"required":["query"]},
		category: "yuanbao",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"chat_id":{"type":"string","description":"Chat ID"},"sticker_id":{"type":"string","description":"Sticker ID"}},"required":["chat_id","sticker_id"]},
		category: "yuanbao",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"doc_id":{"type":"string","description":"Feishu document ID or URL"}},"required":["doc_id"]},
		category: "feishu",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"file_id":{"type":"string","description":"File ID"},"file_type":{"type":"string","description":"File type (e.g., \"doc\", \"sheet\")"}},"required":["file_id","file_type"]},
		category: "feishu",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"file_id":{"type":"string","description":"File ID"},"comment_id":{"type":"string","description":"Comment ID"},"file_type":{"type":"string","description":"File type"}},"required":["file_id","comment_id","file_type"]},
		category: "feishu",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"file_id":{"type":"string","description":"File ID"},"comment_id":{"type":"string","description":"Comment ID"},"content":{"type":"string","description":"Reply content"},"file_type":{"type":"string","description":"File type"}},"required":["file_id","comment_id","content","file_type"]},
		category: "feishu",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"file_id":{"type":"string","description":"File ID"},"content":{"type":"string","description":"Comment content"},"file_type":{"type":"string","description":"File type"}},"required":["file_id","content","file_type"]},
		category: "feishu",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["play","pause","next","previous","seek","volume","shuffle","repeat"],"description":"Playback action"},"position_ms":{"type":"number","description":"Position in milliseconds (for seek)"},"volume_percent":{"type":"number","description":"Volume percentage 0-100 (for volume)"}},"required":["action"]},
		category: "spotify",
		source: 'hermes-bundled',
	},
	{
	...
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["list","add"],"description":"Queue action"},"uri":{"type":"string","description":"Spotify URI to add (for add action)"}}},
		category: "spotify",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"query":{"type":"string","description":"Search query"},"type":{"type":"string","enum":["track","album","artist","playlist"],"description":"Type of results (default: track)"},"limit":{"type":"number","description":"Max results (default: 10)"}},"required":["query"]},
		category: "spotify",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["list","create","add_track","remove_track"],"description":"Playlist action"},"name":{"type":"string","description":"Playlist name (for create)"},"playlist_id":{"type":"string","description":"Playlist ID"},"track_uri":{"type":"string","description":"Track URI to add/remove"}}},
		category: "spotify",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"album_id":{"type":"string","description":"Spotify album ID"}},"required":["album_id"]},
		category: "spotify",
		source: 'hermes-bundled',
	},
	{
		...
		inputSchema: {"type":"object","properties":{"action":{"type":"string","enum":["saved_tracks","save_track","remove_track","contains"],"description":"Library action"},"track_id":{"type":"string","description":"Track ID (for save/remove/contains)"}}},
		category: "spotify",
		source: 'hermes-bundled',
	},
...
/**
 * 工具集定义 — 对应 Hermes toolsets.py 中的 TOOLSETS
 */
...
export const BUNDLED_TOOLSETS: Readonly<Record<string, IToolsetDefinition>> = {
	"web": {
