...
activation: manual
match: [llama-cpp, llama cpp, llama.cpp, gguf, quantization, hugging face hub, cpu inference, apple silicon, edge deployment, amd gpus, intel gpus, nvidia, url-first]
category: mlops
version: 2.1.2
---
