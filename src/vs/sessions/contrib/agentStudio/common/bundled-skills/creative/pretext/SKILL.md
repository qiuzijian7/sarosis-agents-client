...
activation: manual
match: [pretext, creative-coding, typography, ascii-art, canvas, generative, text-layout, kinetic-typography]
category: creative
version: 1.0.0
---
...
2. **Start from a template**:
   ...
   - `file_write` to a new `.html` in `/tmp/` or the user's workspace.
