...
activation: manual
match: [research-paper-writing, research paper writing, research, paper writing, experiments, neurips, icml, iclr, acl, aaai, colm, latex, citations, statistical analysis]
category: research
recommended_tools: [shell_exec, files]
version: 1.1.0
---
...
| **`file_read`** / **`file_write`** / **`patch`** | Paper editing, experiment scripts, result files. Use `patch` for targeted edits to large .tex files. |
