...
const entry = path.join(__dirname, 'publishVersioning.test.ts');
const outfile = path.join(os.tmpdir(), 'publishVersioning.test.js');
...
mocha.run(failures => {
	...
	else { console.log('publishVersioning tests PASSED'); }
});
