...
const entry = path.join(__dirname, 'iterationBudget.test.ts');
const outfile = path.join(os.tmpdir(), 'iterationBudget.test.js');
...
mocha.run(failures => {
	...
	else { console.log('IterationBudget tests PASSED'); }
});
