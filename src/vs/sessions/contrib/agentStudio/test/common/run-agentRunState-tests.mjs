...
const entry = path.join(__dirname, 'agentRunState.test.ts');
const outfile = path.join(os.tmpdir(), 'agentRunState.test.js');
...
mocha.run(failures => {
	...
	else { console.log('AgentRunState tests PASSED'); }
});
