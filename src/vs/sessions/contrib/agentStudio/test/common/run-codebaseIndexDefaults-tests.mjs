...
const entry = path.join(__dirname, 'codebaseIndexDefaults.test.ts');
const outfile = path.join(os.tmpdir(), 'codebaseIndexDefaults.test.js');
...
mocha.run(failures => {
	...
	else { console.log('CodebaseIndexDefaults tests PASSED'); }
});
