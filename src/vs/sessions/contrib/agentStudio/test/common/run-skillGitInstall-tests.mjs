...
const entry = path.join(__dirname, 'skillGitInstall.test.ts');
const outfile = path.join(os.tmpdir(), 'skillGitInstall.test.js');
...
mocha.run(failures => {
	...
	else { console.log('SkillGitInstall tests PASSED'); }
});
