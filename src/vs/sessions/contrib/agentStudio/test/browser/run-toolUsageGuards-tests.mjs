...
const entry = path.join(__dirname, 'toolUsageGuards.test.ts');
const outfile = path.join(os.tmpdir(), 'toolUsageGuards.test.js');
...
mocha.run(failures => {
	...
	else { console.log('ToolUsageGuards tests PASSED'); }
});
