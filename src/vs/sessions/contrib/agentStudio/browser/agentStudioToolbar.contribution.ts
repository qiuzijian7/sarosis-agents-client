...
//
// The duplicate registration caused "A view with id 'X' is already registered" errors
// and was the root cause of SettingsViewPane rendering with 0×0 dimensions.
