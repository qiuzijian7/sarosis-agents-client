...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'instance': { type: 'string', cat: 'o', args: 'id', description: localize('instance', "Runs a separate process instance sharing the same user data directory. Mutable state (storage, backups, logs) is isolated per instance id; agents, skills and settings are shared.") },
	'profile': { type: 'string', 'cat': 'o', args: 'profileName', description: localize('profileName', "Opens the provided folder or workspace with the given profile and associates the profile with the workspace. If the profile does not exist, a new empty one is created.") },
