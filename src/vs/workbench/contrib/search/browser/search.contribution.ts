...
import { Extensions as ViewExtensions, IViewContainersRegistry, ViewContainerLocation, WindowEnablement } from '../../../common/views.js';
...
import { SearchSortOrder, SEARCH_EXCLUDE_CONFIG, VIEWLET_ID, ViewMode, DEFAULT_MAX_SEARCH_RESULTS, SemanticSearchBehavior } from '../../../services/search/common/search.js';
...
// [Sarosis] Register the container (hidden via WindowEnablement.Sessions) for compatibility.
// The actual SearchView is now hosted in the Agent Studio sidebar container.
