...
// [Sarosis] Sessions window removed — Agent Studio now lives in the main window's AuxiliaryBar
...
// [Sarosis] Sessions window removed — no longer auto-open agents window
