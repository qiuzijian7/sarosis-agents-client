...
// Agent Studio - services & configuration for main window integration
import './agentStudio.contribution.js';
...
// [Sarosis] Disabled Copilot setup/teardown — Agent Studio replaces Chat panel
