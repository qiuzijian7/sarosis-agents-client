...
import { sanitizeAssistantVisibleText, isEntirelyToolCallContent, } from '../../common/assistantVisibleText.js';
// ════════════════════════════════════════════════════════════════════════════════
 ...
 */
function replaceToolBlocksWithPlaceholders(text) {
    if (!text) {
        return text;
    }
    let result = text;
 ...
 */
function fullContentPipeline(text) {
    if (!text) {
        return text;
    }
 ...
 */
function parseInterleavedOutput(processedText, toolCallIds) {
    const result = [];
