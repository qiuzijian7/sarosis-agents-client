...
exports.Ellipsis = exports.InvisibleCharacters = exports.AmbiguousCharacters = exports.noBreakWhitespace = exports.UTF8_BOM_CHARACTER = exports.UNUSUAL_LINE_TERMINATORS = exports.GraphemeIterator = exports.CodePointIterator = void 0;
...
exports.indexOfPattern = indexOfPattern;
...
function truncate(value, maxLength, suffix = exports.Ellipsis) {
    if (value.length <= maxLength) {
        return value;
    }
    return `${value.substr(0, maxLength)}${suffix}`;
}
function truncateMiddle(value, maxLength, suffix = exports.Ellipsis) {
    if (value.length <= maxLength) {
        return value;
    }
...
class AmbiguousCharacters {
    ...
    static cache = new cache_js_1.LRUCachedFunction((localesStr) => {
