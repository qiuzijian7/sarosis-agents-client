...
exports.logObservableToConsole = logObservableToConsole;
...
function logObservableToConsole(obs) {
    if (!consoleObservableLogger) {
        ...
        (0, logging_js_1.addLogger)(consoleObservableLogger);
    }
...
function formatObject(value, availableLen) {
    ...
    const className = (0, debugName_js_1.getClassName)(value);
