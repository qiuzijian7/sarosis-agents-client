...
class Derived extends baseObservable_js_1.BaseObservable {
    _debugNameData;
    _computeFn;
    _changeTracker;
    _handleLastObserverRemoved;
    _equalityComparator;
    _state = 0 /* DerivedState.initial */;
    _value = undefined;
    _updateCount = 0;
    _dependencies = new Set();
    _dependenciesToBeRemoved = new Set();
    _changeSummary = undefined;
    _isUpdating = false;
    _isComputing = false;
    _didReportChange = false;
    _isInBeforeUpdate = false;
    ...
    onLastObserverRemoved() {
        ...
        (0, logging_js_1.getLogger)()?.handleDerivedCleared(this);
    ...
    _recompute() {
        ...
        try {
            ...
            (0, logging_js_1.getLogger)()?.handleObservableUpdated(this, {
                oldValue,
    ...
    handleChange(observable, change) {
        if (this._dependencies.has(observable) && !this._dependenciesToBeRemoved.has(observable) || this._isInBeforeUpdate) {
            (0, logging_js_1.getLogger)()?.handleDerivedDependencyChanged(this, observable, change);
