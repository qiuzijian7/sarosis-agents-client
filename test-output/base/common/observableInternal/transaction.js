...
class TransactionImpl {
    ...
    updateObserver(observer, observable) {
        if (!this._updatingObservers) {
            ...
            (0, base_js_1.handleBugIndicatingErrorRecovery)('Transaction already finished!');
            // Error recovery
            transaction(tx => {
    ...
    finish() {
        ...
        if (!updatingObservers) {
            (0, base_js_1.handleBugIndicatingErrorRecovery)('transaction.finish() has already been called!');
            return;
        }
        ...
        (0, logging_js_1.getLogger)()?.handleEndTransaction(this);
    }
