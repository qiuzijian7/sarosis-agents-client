...
exports.DisposableResourceMap = exports.DisposableSet = exports.DisposableMap = exports.ImmortalReference = exports.AsyncReferenceCollection = exports.ReferenceCollection = exports.RefCountedDisposable = exports.MandatoryMutableDisposable = exports.MutableDisposable = exports.Disposable = exports.DisposableStore = exports.DisposableTracker = exports.GCBasedDisposableTracker = void 0;
...
class DisposableStore {
    ...
    assertNotDisposed() {
        if (this._isDisposed) {
            (0, errors_js_1.onUnexpectedError)(new errors_js_1.BugIndicatingError('Object disposed'));
        }
    }
}
...
class DisposableResourceMap extends DisposableMap {
    constructor() {
        super(new map_js_1.ResourceMap());
    }
}
