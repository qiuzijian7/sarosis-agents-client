...
// Using no-op tasks to preserve exports needed by gulpfile.ts (compileExtensionMediaTask)
export const compileExtensionMediaTask = task.define('compile-extension-media', () => Promise.resolve());
gulp.task(compileExtensionMediaTask);

export const watchExtensionMedia = task.define('watch-extension-media', () => Promise.resolve());
gulp.task(watchExtensionMedia);

export const compileExtensionMediaBuildTask = task.define('compile-extension-media-build', () => Promise.resolve());
